...
//check if there is a transaction input duplicate in transaction inputs
...
//check if is coinbase transaction valid
const validateCoinbaseTx = (transaction, blockIndex) => {
  ...
  //txOutIndex base on height of blockchain to distingush with others
...
//check TxIn if it is in Unspent transaction outputs and its signature
...
//create signature for one transaction input
...
//each time a block is added to blockchain, we have to update Unspent Transaction Outs
const updateUnspentTxOuts = (aTransactions, aUnspentTxOuts) => {
  //get all outs in transactions in new block and create a new UnspentTxOuts of this transaction
  ...
  //get all ins in transactions in new block and create a new consumedTxOuts of this transaction
