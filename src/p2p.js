      ...
      switch (message.type) {
        ...
        case MessageType.RESPONSE_BLOCKCHAIN:
          ...
          if (receivedBlocks === null) {
            console.log(
              `invalid blocks received: ${JSON.stringify(message.data)}`
            );
            break;
          }
        ...
        case MessageType.RESPONSE_TRANSACTION_POOL:
          ...
          if (receivedTransactions === null) {
            console.log(
              `invalid transaction received: ${JSON.stringify(message.data)}`
            );
            break;
          }
...
const handleBlockchainResponse = (receivedBlocks) => {
    ...
    const lastestBlockHeld = getLatestBlock();//lastestBblock of local
    if(lastestBlockReceived.index > lastestBlockHeld.index) {
        console.log(`blockchain possibly behind. We got: ${latestBlockHeld.index} Peer get ${latestBlockReceived.index}`);
...
module.exports = {
    connectToPeers, broadcastLastest, broadCastTransactionPool, initP2PServer, getSockets
}